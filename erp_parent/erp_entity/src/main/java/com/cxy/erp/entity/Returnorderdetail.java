...
public class Returnorderdetail {	
	...
	public String toString() {
		return "Returnorderdetail [uuid=" + uuid + ", goodsuuid=" + goodsuuid + ", goodsname=" + goodsname + ", price="
				+ price + ", num=" + num + ", money=" + money + ", endtime=" + endtime + ", ender=" + ender
				+ ", storeuuid=" + storeuuid + ", state=" + state + "]";
	}
